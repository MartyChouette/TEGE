...
// handshake and the reliable channel testable at all: the previous round of
// collaboration fixes had to be verified by launching two editors and reading
// their logs, because nothing here could stand in for a socket.
// ============================================================================
