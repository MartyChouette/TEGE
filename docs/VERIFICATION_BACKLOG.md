...
18. **FBX/OBJ import golden (Assimp path)** — OBJ is text and trivial to author; covers `AssimpLoader`/`ImportAssimp`, the one import path our glTF golden test doesn't reach. *(The original item that started this list.)*
