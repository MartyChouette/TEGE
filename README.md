...
- **Physics** — `IPhysicsBackend` abstraction with Jolt Physics v5.2.0 (3D) and Box2D v3.0.0 (2D) backends enabled by default. Collision detection, 2D/3D ground detection for character controllers, sensor body sync for controller/AI/tween-driven entities, debug wireframes for colliders and joints
