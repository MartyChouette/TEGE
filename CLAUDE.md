...
- **Scripting:** AngelScript (~390 bindings incl. AI/BT/navmesh + accessibility + procedural gen + audio graph + plugins), visual scripting (126+ nodes, debugger), state machines with script callbacks, coroutines, event system, DataAsset system (schemas + instances, JSON I/O, AS + VS bindings), documentation generator, plugin DLL repositories
