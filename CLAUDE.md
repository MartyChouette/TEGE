...
- **Ray tracing:** Full RT pipeline (shadows/reflections/AO/GI/translucency/caustics/path tracing, SVGF+OIDN+OptiX denoisers). RT descriptor set: 20 bindings (0-13 base, 14=translucency, 15=caustics, 16=NEE lights, 17=SDF, 18=simplified materials, 19=ReSTIR reservoirs). RTCompositor enable flags: bits 0-5 (shadows/reflections/AO/GI/translucency/caustics). ReSTIR: importance-weighted light selection compute shader, per-pixel reservoir buffer (binding 19). Auto-activates on RT-capable hardware. CMake: `ENJIN_RAYTRACING_OIDN`, `ENJIN_RAYTRACING_OPTIX`.
