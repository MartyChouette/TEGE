...
void ImGuiLayer::ApplyTheme(Editor::EditorTheme theme) {
    ImGuiStyle& style = ImGui::GetStyle();
    ImVec4* colors = style.Colors;
    ...
    switch (theme) {
        ...
        default: {
            // Dark blue-gray theme (original Enjin theme)
            colors[ImGuiCol_WindowBg]             = ImVec4(0.10f, 0.10f, 0.13f, 1.00f);
            colors[ImGuiCol_ChildBg]              = ImVec4(0.08f, 0.08f, 0.10f, 1.00f);
            colors[ImGuiCol_PopupBg]              = ImVec4(0.12f, 0.12f, 0.15f, 0.95f);
            colors[ImGuiCol_Border]               = ImVec4(0.25f, 0.25f, 0.30f, 0.60f);
        ...
        case Editor::EditorTheme::Light: {
            ...
            colors[ImGuiCol_TitleBgActive]        = ImVec4(0.76f, 0.80f, 0.88f, 1.00f);
            ...
            colors[ImGuiCol_CheckMark]            = ImVec4(0.20f, 0.40f, 0.75f, 1.00f);
            colors[ImGuiCol_SliderGrab]           = ImVec4(0.30f, 0.50f, 0.80f, 1.00f);
            colors[ImGuiCol_SliderGrabActive]     = ImVec4(0.20f, 0.40f, 0.70f, 1.00f);
            colors[ImGuiCol_Button]               = ImVec4(0.78f, 0.80f, 0.86f, 1.00f);
            colors[ImGuiCol_ButtonHovered]        = ImVec4(0.68f, 0.72f, 0.82f, 1.00f);
            colors[ImGuiCol_ButtonActive]         = ImVec4(0.58f, 0.64f, 0.78f, 1.00f);
            colors[ImGuiCol_Header]               = ImVec4(0.78f, 0.80f, 0.86f, 1.00f);
            colors[ImGuiCol_HeaderHovered]        = ImVec4(0.68f, 0.72f, 0.82f, 1.00f);
            colors[ImGuiCol_HeaderActive]         = ImVec4(0.58f, 0.64f, 0.78f, 1.00f);
            colors[ImGuiCol_Separator]            = ImVec4(0.70f, 0.70f, 0.70f, 0.50f);
            colors[ImGuiCol_ResizeGrip]           = ImVec4(0.60f, 0.65f, 0.75f, 0.50f);
            colors[ImGuiCol_ResizeGripHovered]    = ImVec4(0.45f, 0.55f, 0.75f, 0.70f);
            colors[ImGuiCol_ResizeGripActive]     = ImVec4(0.35f, 0.48f, 0.72f, 0.90f);
            colors[ImGuiCol_Tab]                  = ImVec4(0.82f, 0.82f, 0.86f, 1.00f);
            colors[ImGuiCol_TabHovered]           = ImVec4(0.60f, 0.68f, 0.82f, 1.00f);
            colors[ImGuiCol_TabActive]            = ImVec4(0.70f, 0.76f, 0.88f, 1.00f);
            colors[ImGuiCol_TextSelectedBg]       = ImVec4(0.50f, 0.62f, 0.82f, 0.50f);
        ...
        case Editor::EditorTheme::HighContrastDark: {
            ...
            colors[ImGuiCol_SliderGrabActive]     = ImVec4(0.50f, 0.90f, 1.00f, 1.00f);
            colors[ImGuiCol_Button]               = ImVec4(0.15f, 0.15f, 0.25f, 1.00f);
            colors[ImGuiCol_ButtonHovered]        = ImVec4(0.25f, 0.30f, 0.50f, 1.00f);
            colors[ImGuiCol_ButtonActive]         = ImVec4(0.35f, 0.40f, 0.65f, 1.00f);
            colors[ImGuiCol_Header]               = ImVec4(0.15f, 0.15f, 0.25f, 1.00f);
            colors[ImGuiCol_HeaderHovered]        = ImVec4(0.25f, 0.30f, 0.50f, 1.00f);
            colors[ImGuiCol_HeaderActive]         = ImVec4(0.35f, 0.40f, 0.65f, 1.00f);
            colors[ImGuiCol_Separator]            = ImVec4(0.80f, 0.80f, 0.80f, 0.70f);
            colors[ImGuiCol_ResizeGrip]           = ImVec4(0.50f, 0.60f, 0.90f, 0.60f);
            colors[ImGuiCol_ResizeGripHovered]    = ImVec4(0.60f, 0.70f, 1.00f, 0.80f);
            colors[ImGuiCol_ResizeGripActive]     = ImVec4(0.70f, 0.80f, 1.00f, 1.00f);
            colors[ImGuiCol_Tab]                  = ImVec4(0.10f, 0.10f, 0.15f, 1.00f);
            colors[ImGuiCol_TabHovered]           = ImVec4(0.30f, 0.35f, 0.60f, 1.00f);
            colors[ImGuiCol_TabActive]            = ImVec4(0.20f, 0.25f, 0.45f, 1.00f);
            colors[ImGuiCol_TextSelectedBg]       = ImVec4(0.30f, 0.50f, 0.80f, 0.60f);
            colors[ImGuiCol_DragDropTarget]       = ImVec4(0.40f, 0.80f, 1.00f, 1.00f);
            colors[ImGuiCol_Text]                 = ImVec4(1.00f, 1.00f, 1.00f, 1.00f);
        ...
        case Editor::EditorTheme::HighContrastLight: {
            ...
            colors[ImGuiCol_CheckMark]            = ImVec4(0.00f, 0.30f, 0.70f, 1.00f);
            colors[ImGuiCol_SliderGrab]           = ImVec4(0.00f, 0.30f, 0.70f, 1.00f);
            colors[ImGuiCol_SliderGrabActive]     = ImVec4(0.00f, 0.20f, 0.60f, 1.00f);
            colors[ImGuiCol_Button]               = ImVec4(0.82f, 0.84f, 0.90f, 1.00f);
            colors[ImGuiCol_ButtonHovered]        = ImVec4(0.68f, 0.72f, 0.84f, 1.00f);
            colors[ImGuiCol_ButtonActive]         = ImVec4(0.55f, 0.62f, 0.78f, 1.00f);
            colors[ImGuiCol_Header]               = ImVec4(0.82f, 0.84f, 0.90f, 1.00f);
            colors[ImGuiCol_HeaderHovered]        = ImVec4(0.68f, 0.72f, 0.84f, 1.00f);
            colors[ImGuiCol_HeaderActive]         = ImVec4(0.55f, 0.62f, 0.78f, 1.00f);
            colors[ImGuiCol_Separator]            = ImVec4(0.00f, 0.00f, 0.00f, 0.60f);
            colors[ImGuiCol_ResizeGrip]           = ImVec4(0.30f, 0.40f, 0.65f, 0.60f);
            colors[ImGuiCol_ResizeGripHovered]    = ImVec4(0.20f, 0.30f, 0.60f, 0.80f);
            colors[ImGuiCol_ResizeGripActive]     = ImVec4(0.10f, 0.20f, 0.55f, 1.00f);
            colors[ImGuiCol_Tab]                  = ImVec4(0.88f, 0.88f, 0.92f, 1.00f);
            colors[ImGuiCol_TabHovered]           = ImVec4(0.65f, 0.70f, 0.85f, 1.00f);
            colors[ImGuiCol_TabActive]            = ImVec4(0.75f, 0.80f, 0.92f, 1.00f);
            colors[ImGuiCol_TextSelectedBg]       = ImVec4(0.40f, 0.55f, 0.80f, 0.50f);
            colors[ImGuiCol_DragDropTarget]       = ImVec4(0.00f, 0.40f, 0.90f, 0.90f);
