...
bool OITManager::CreateCompositePipeline(VkRenderPass opaqueRenderPass) {
    ...
    vertInfo.codeSize = Renderer::ShaderData::FullscreenVertexShaderDataSize;
    vertInfo.pCode = reinterpret_cast<const uint32_t*>(Renderer::ShaderData::FullscreenVertexShaderData);
    ...
    fragInfo.codeSize = Renderer::ShaderData::OitCompositeFragmentShaderDataSize;
    fragInfo.pCode = reinterpret_cast<const uint32_t*>(Renderer::ShaderData::OitCompositeFragmentShaderData);
