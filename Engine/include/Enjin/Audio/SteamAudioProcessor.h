...
// Steam Audio HRTF binaural processor
// Processes mono 3D audio through HRTF for binaural headphone rendering.
// Thread safety: CreateSource/DestroySource are mutex-guarded.
// SetSourceDirection is main-thread only (benign race with audio thread).
